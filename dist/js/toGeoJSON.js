function $(element, tagName) {
  ...
  function getPlacemark(node, styleMap, schema, options) {var _feature$properties;
  ...
  function getGroundOverlay(node, styleMap, schema, options) {var _feature$properties2;
